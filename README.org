...
(use-package obs-websocket
  ...
  (with-eval-after-load 'transient
    (transient-define-prefix my/obs-wesbocket-tmenu ()
...
If you have a local installation of it, you can use =M-x loaddefs-generate= or =make= to generate the autoloads and then use something like this:

#+begin_src emacs-lisp
(use-package obs-websocket
  :load-path "~/code/obs-websocket-el"
  :preface (load "~/code/obs-websocket-el/obs-websocket-autoloads.el" t t)
  :bind (("<f8>" . my/obs-websocket-tmenu)))
#+end_src
